...
const PanelMenuButton = new Lang.Class({
	...
	// DW: 20130802 fix bug that makes app icon larger
        // this.actor.add_style_class_name('panel-status-button');
        this._box = new St.BoxLayout({ style_class: 'gnomenu-panel-menu-button' });
        this.actor.add_actor(this._box);

        // Add icon to button
	// DW: 20130802 do not show icon
        // let icon = new St.Icon({ gicon: null, style_class: 'system-status-icon' });
        // this._box.add_actor(icon);
        // icon.icon_name='start-here';
	...
	// DW: moved to PowerGroup area code
	...
	// DW: exchange title and description position to get a better outlook
